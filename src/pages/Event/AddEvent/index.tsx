...
import { View, ImageBackground, Text, KeyboardAvoidingView, Picker, Alert, Button, Platform } from 'react-native';
...
function AddEvent() {
    ...
    const [selectedValueAddress, setSelectedValueAddress] = useState("addressNull");
    const [selectedValueCategory, setSelectedValueCategory] = useState("categoryNull");
            ...
            <KeyboardAwareScrollView behavior="position" enabled>
                <View style={styles.containerForm}>
                    ...
                    <View style={styles.picker}>
                        ...
                        >
                            <Picker.Item label="Selecione uma Categoria" value="categoryNull" color="#CDC9C9" />
                    ...
                    <View style={styles.picker}>
                        <Picker
                            ...
                            style={{ height: 50, borderRadius: 15, }}
                            onValueChange={(itemValue, itemIndex) => setSelectedValueAddress(itemValue)}
                        >
                            <Picker.Item label="Selecione um Endereço" value="addressNull" color="#CDC9C9" />
                            {addresses.map((address: Address) => <Picker.Item
                    ...
                    <View style={styles.ContainerDataTime}>
                        <View style={styles.containerDate}>
                            ...
                            <Text style={styles.resultData}> {moment(date).format('DD/MM/YYYY')}</Text>
                        </View>
                        <View style={styles.containerDate}>
                            ...
                            <Text style={styles.resultData}> {moment(date).format('HH:mm')}</Text>
                        </View>
                    </View>

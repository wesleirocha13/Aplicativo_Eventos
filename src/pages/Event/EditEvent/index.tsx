...
import { View, ImageBackground, Text, KeyboardAvoidingView, Picker, Alert  } from 'react-native';
...
function EditEvent({ route, navigation }) {
    ...
    async function loadEvent() {
        ...
        const date = new Date(moment(response.data.date).format('ddd MMM DD YYYY HH:mm:ss ZZ'));
        setDate(date);
        loadAddressCompany();
    };
